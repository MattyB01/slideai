...
export default function Toolbar() {
  ...
  return (
    <header className="h-12 bg-white border-b border-zinc-200 flex items-center px-4 gap-3 shrink-0">
      ...
      {/* File name */}
      <span className="text-sm text-zinc-600 font-medium truncate max-w-[160px]">
        {displayName}
      </span>
      ...
      <div className="relative" ref={themeRef}>
        ...
        {themeOpen && (
          <div className="absolute right-0 top-full mt-1 w-64 bg-white border border-zinc-200 rounded-xl shadow-lg shadow-zinc-200/50 z-50 py-1.5">
            ...
            {themePresets.map((preset) => (
              <button
                ...
                className="
                  ...
                  text-sm text-left text-zinc-700
